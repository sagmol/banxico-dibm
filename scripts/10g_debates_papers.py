...
DEBATES = [
    ...
    ("dinero_endog", "Dinero endógeno (Kaldor, Moore, Lavoie)",
     ["endogenous money", "horizontalism", "endogenous credit", "dinero endógeno", "money creation"]),
    ...
    ("prebisch",     "Prebisch / CEPAL / estructuralismo latinoam.",
     ["prebisch", "cepal", "structuralist latin", "terms of trade",
      "deterioro de los términos", "estructuralismo"]),
